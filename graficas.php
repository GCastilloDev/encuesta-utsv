...
<body class="dashboard-page">
	...
	<section class="wrapper scrollable">
		...
		<div class="main-grid">
			...
			<p>
            <h1 class="text-center" style="margin-bottom:20px">Gráficas de encuestas</h1>
            </p>

            <div class="social grid">
				<div class="grid-info container">

                <a href='./graficas-seis-meses.php'>
                    <div class='col-lg-3 col-md-3'>							
                        <div class='panel panel-default'>
                            <div class='panel-heading text-center' style='background: #099025; color: white'><b>Gráficas de seis meses</b></div>
                            <div class='panel-body'><center><h1><i class='icon-bar-chart pagination-lg' style='font-size:100px; color: #099025;'></i></h1></center></div>
                        </div>						
                    </div>
                </a>

                <a href='./graficas-un-anio.php'>
                    <div class='col-lg-3 col-md-3'>							
                        <div class='panel panel-default'>
                            <div class='panel-heading text-center' style='background: #099025; color: white'><b>Gráficas de un año</b></div>
                            <div class='panel-body'><center><h1><i class='icon-bar-chart pagination-lg' style='font-size:100px; color: #099025;'></i></h1></center></div>
                        </div>						
                    </div>
                </a>
